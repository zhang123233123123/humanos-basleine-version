...
- `聚焦编码全量审计.md`: 对93条聚焦编码的完整性、类别边界、证据构成、反例和解释限制进行审计；
- `候选主题_v0.1.md`: 从聚焦类别关系生成的四个候选主题，逐项保留支持材料、反例、证据层级和主张边界；
- `主题审查矩阵_v0.1.md`: 将93条记录逐条映射至候选主题并审查内部一致性、重叠和反例，形成三个经验主题与一个跨主题设计边界层；
- `最终主题与论文证据包_v1.0.md`: 定义三个最终经验主题及跨主题边界层，提供代表案例、反例、证据等级和论文最小主张；
- `JITAI理论对照_v1.0.md`: 在最终主题之后进行的理论对照，区分候选 JITAI 构件、尚未验证的决策规则与 HumanOS 的合理系统定位；
