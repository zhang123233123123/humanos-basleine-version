        ...
        *,
        ...
        self.connection.execute(
            ...
            (
                ...
                remaining_at_pause, interruption_snapshot_json or "{}", profile_trait_refs_json or "[]", parallel_context_json or "{}",
