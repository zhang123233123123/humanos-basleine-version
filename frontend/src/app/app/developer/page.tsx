...
type Tab = 'overview' | 'plans' | 'sessions' | 'tasks' | 'checkin' | 'events'
...
export default function DeveloperPage() {
  ...
  const tabs: Array<[Tab, string]> = [['overview', 'Overview'], ['plans', 'Plan revisions'], ['sessions', 'Execution sessions'], ['tasks', 'Tasks'], ['checkin', 'Daily check-in'], ['events', 'Event log']]
