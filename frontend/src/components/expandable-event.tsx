...
export function ExpandableEvent(props: EventContentArg) {
  ...
  const isPreview = (event.extendedProps as any)?.isPreview || false
        ...
        <motion.div
          ...
          className={cn(
            'w-full h-full overflow-hidden bg-background dark:bg-background/90 p-[0.5px] rounded-md cursor-pointer',
            {
              ...
              'border border-dashed border-primary/50': isPreview,
            },
          )}
        >
          <div
          ...
          >
            <div className={cn('h-full w-1 bg-primary rounded-md flex-shrink-0')} />
